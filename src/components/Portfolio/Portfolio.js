      ...
      <div className="portfolio portfolio__container">
        ...
        <ul className="portfolio__links">
          <li className="portfolio__link">
            <Link className="link" target="_blank" to="https://github.com/ChisvinAndrew1/how-to-learn.git">
            <p className="link__text">Статичный сайт</p>
            <span className="link__arrow"></span>
          </Link>
          </li>
          <li className="portfolio__link">
            <Link className="link" target="_blank" to="https://github.com/ChisvinAndrew1/russian-travel.git">
            <p className="link__text">Адаптивный сайт</p>
            <span className="link__arrow"></span>
          </Link>
          </li>
          <li className="portfolio__link">
            <Link className="link" target="_blank" to="https://github.com/ChisvinAndrew1/react-mesto-api-full.git">
